...
--
-- 	: localhost    Database: xettuyen2026
-- ------------------------------------------------------
...
-- USE `xettuyen2026`;
-- DROP TABLE IF EXISTS `xettuyen2026`;

CREATE DATABASE IF NOT EXISTS `xettuyen2026`
...
CREATE TABLE `xt_diemthixettuyen` (
  ...
  `is_active` TINYINT(1) NOT NULL DEFAULT 1 COMMENT '1: active, 0: hidden (soft delete)',
...
-- ------------------------------------------------------
-- Table structure for table `tai_khoan` (Nhom 5 tu them)
-- ------------------------------------------------------
...
INSERT INTO `tai_khoan` VALUES (1,'admin','123456','Quản trị viên Hệ thống','Admin',1);
